...
layout: page
title: "Уменьшаем"
excerpt: "Пишем о проблемах животных и о том, как можно им помочь. О редуктарианстве, флекситарианстве и веганстве. Редуктарианство — это намеренное уменьшение потребления продуктов животного происхождения, таких как мясо, яйца, мех или молочные продукты."
---
